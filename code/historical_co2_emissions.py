...
class HistoricalCO2Emissions():
    ...
    def get_total_emissions_Mt(self, year):
        ''' Find the total emissions for a particular year in MtCO2
            Parameters:
                year - Year to include in the results. String in the form 'YYYY'
            Returns:
        ...
        return global_emissions.unstack(level=1).values
